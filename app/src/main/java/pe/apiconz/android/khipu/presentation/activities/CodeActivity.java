...
public class CodeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String barCodeData = getIntent().getStringExtra(Intent.EXTRA_TEXT);
...
//        Bitmap bitmap = null;
        ...
        Bitmap bitmap = encodeAsBitmap(barCodeData, BarcodeFormat.CODE_128, 800, 400);
